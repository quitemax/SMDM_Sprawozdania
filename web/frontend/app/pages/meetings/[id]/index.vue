...
<template>
  <div>
    <NuxtLink class="link-button" to="/meetings">&larr; Powrót do listy spotkań</NuxtLink>
    ...
    <p class="row">
      ...
      <NuxtLink class="link-button" :to="`/meetings/${meetingId}/report`">Projekt sprawozdania</NuxtLink>
    </p>
